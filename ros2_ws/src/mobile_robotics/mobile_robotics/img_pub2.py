...
class ImagePublisher(Node):
  ...
  def __init__(self):
    ...
    self.publisher_left = self.create_publisher(Image, 'tara_img_left', 10)
    self.publisher_right = self.create_publisher(Image, 'tara_img_right', 10)
